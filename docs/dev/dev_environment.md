...
- `project_name`: the default docker compose project name (default: `nautobot-app-mcp-server`)
...
#14 naming to docker.io/nautobot-app-mcp-server/nautobot:3.0.0-py3.12 done
```
...
Creating network "nautobot_app_mcp_server_default" with the default driver
Creating volume "nautobot_app_mcp_server_postgres_data" with default driver
Creating nautobot_app_mcp_server_redis_1 ...
Creating nautobot_app_mcp_server_docs_1  ...
Creating nautobot_app_mcp_server_postgres_1 ...
Creating nautobot_app_mcp_server_postgres_1 ... done
Creating nautobot_app_mcp_server_redis_1    ... done
Creating nautobot_app_mcp_server_nautobot_1 ...
Creating nautobot_app_mcp_server_docs_1     ... done
Creating nautobot_app_mcp_server_nautobot_1 ... done
Creating nautobot_app_mcp_server_worker_1   ...
Creating nautobot_app_mcp_server_worker_1   ... done
...
ee90fbfabd77   nautobot-app-mcp-server/nautobot:3.0.0-py3.12  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_app_mcp_server_worker_1
b8adb781d013   nautobot-app-mcp-server/nautobot:3.0.0-py3.12  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_app_mcp_server_nautobot_1
d64ebd60675d   nautobot-app-mcp-server/nautobot:3.0.0-py3.12  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_app_mcp_server_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nautobot_app_mcp_server_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_app_mcp_server_redis_1
```
...
Stopping nautobot_app_mcp_server_worker_1   ...
Stopping nautobot_app_mcp_server_nautobot_1 ...
Stopping nautobot_app_mcp_server_docs_1     ...
Stopping nautobot_app_mcp_server_redis_1    ...
Stopping nautobot_app_mcp_server_postgres_1 ...
Stopping nautobot_app_mcp_server_worker_1   ... done
Stopping nautobot_app_mcp_server_nautobot_1 ... done
Stopping nautobot_app_mcp_server_postgres_1 ... done
Stopping nautobot_app_mcp_server_redis_1    ... done
Stopping nautobot_app_mcp_server_docs_1     ... done
Removing nautobot_app_mcp_server_worker_1   ...
Removing nautobot_app_mcp_server_nautobot_1 ...
Removing nautobot_app_mcp_server_docs_1     ...
Removing nautobot_app_mcp_server_redis_1    ...
Removing nautobot_app_mcp_server_postgres_1 ...
Removing nautobot_app_mcp_server_postgres_1 ... done
Removing nautobot_app_mcp_server_docs_1     ... done
Removing nautobot_app_mcp_server_worker_1   ... done
Removing nautobot_app_mcp_server_redis_1    ... done
Removing nautobot_app_mcp_server_nautobot_1 ... done
Removing network nautobot_app_mcp_server_default
```
...
So for example, our app is named `nautobot-app-mcp-server`, the command would most likely be `docker logs nautobot_app_mcp_server_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_app_mcp_server")
namespace.configure(
    {
        "nautobot_app_mcp_server": {
            ...
...
Or set the `INVOKE_NAUTOBOT_APP_MCP_SERVER_PYTHON_VER` variable.
...
Or set the `INVOKE_NAUTOBOT_APP_MCP_SERVER_NAUTOBOT_VER` variable.
...
In the package source, there is the `nautobot_app_mcp_server/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
