...
```no-highlight
> poetry version
nautobot-app-mcp-server 1.0.0-beta.2
```
...
Draft a [new release](https://github.com/latuannetnam/nautobot-app-mcp-server/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/latuannetnam/nautobot-app-mcp-server/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/latuannetnam/nautobot-app-mcp-server/compare/v1.4.1...v1.4.2
```
