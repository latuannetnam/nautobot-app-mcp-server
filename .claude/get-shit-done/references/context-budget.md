...
The keys live in `.claude/settings.json` (project) or `/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/settings.json` (global) — **not** in `.planning/config.json`:
