...
```bash
AUDITOR_MODEL=$(node "/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/agents/gsd-eval-auditor.md for instructions.
