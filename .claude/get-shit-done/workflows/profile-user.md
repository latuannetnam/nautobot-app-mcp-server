...
```bash
cp "/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/get-shit-done/USER-PROFILE.md" "/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/USER-PROFILE.backup.md"
```
