...
- **Global scope**: `/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/notes/`)
...
2. Glob `/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/notes/` — works in any directory
