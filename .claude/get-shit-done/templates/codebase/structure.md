...
- Usage: Reference from command with `@/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
