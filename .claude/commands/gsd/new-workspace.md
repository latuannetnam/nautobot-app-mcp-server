...
<process>
Execute the new-workspace workflow from @/home/latuan/Local_Programming/nautobot-project/nautobot-app-mcp-server/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
